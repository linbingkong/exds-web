...
const FULL_HEIGHT_TAB_PATHS = ['/price-analysis/mid-long-trend', '/price-forecast/day-ahead', '/system-settings/user-permissions', '/strategy/rolling-match-quotes', '/energy-storage/freq-regulation-market', '/energy-storage/station-operation-info', '/energy-storage/declaration-strategy'];
            ...
            >
                ...
                <Box
                    sx={{
                        ...
                        overflow: FULL_BLEED_TAB_PATHS.includes(activeTabKey || '') || FULL_HEIGHT_TAB_PATHS.includes(activeTabKey || '') ? { xs: 'auto', md: 'hidden' } : 'auto',
                        minHeight: 0,
                        ...
                        openTabs.map((tab) => (
                            <Box
                                ...
                                sx={{
                                    ...
                                    flexDirection: 'column',
                                    height: FULL_BLEED_TAB_PATHS.includes(tab.key) || FULL_HEIGHT_TAB_PATHS.includes(tab.key) ? { xs: 'auto', md: '100%' } : 'auto',
                                    minHeight: 0,
                                    width: '100%',
                                }}
                            >
