...
MODULE_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    {"menu_group": "储能运营", "module_name": "调频市场价格", "module_code": "freq_regulation_market", "route_paths": ["/energy-storage/freq-regulation-market"], "sort_order": 85},
    {"menu_group": "储能运营", "module_name": "电站运行信息", "module_code": "energy_station_operation_info", "route_paths": ["/energy-storage/station-operation-info"], "sort_order": 86},
    {"menu_group": "储能运营", "module_name": "储能申报策略", "module_code": "storage_declaration_strategy", "route_paths": ["/energy-storage/declaration-strategy"], "sort_order": 87},
    {"menu_group": "储能运营", "module_name": "储能收益结算", "module_code": "storage_revenue_settlement", "route_paths": ["/energy-storage/revenue-settlement"], "sort_order": 88},
